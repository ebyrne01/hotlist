            ...
            <div>
              ...
              <p className="mt-1 text-sm font-body">
                ...
                <Link
                  ...
                  className="inline-flex min-h-11 items-center rounded px-1 -my-3 text-fire hover:text-fire/80 transition-colors"
                >
                  {book.author}
                </Link>
                {book.seriesName && (
                  <span className="text-muted">
                    ...
                    <a
                      href="#series-nav"
                      className="inline-flex min-h-11 items-center rounded px-1 -my-3 hover:underline hover:text-fire transition-colors"
                    >
                      {book.seriesName}
                    </a>
                    {book.seriesPosition && (
              ...
              <div className="mt-1 flex items-center flex-wrap gap-x-2 gap-y-0.5">
                ...
                {book.spotifyPlaylists && book.spotifyPlaylists.length > 0 && (
                  <a
                    ...
                    className="inline-flex min-h-11 items-center gap-1 rounded px-2 -my-3 text-xs font-mono text-[#1DB954] hover:text-[#1ed760] transition-colors"
                  >
                  ...
                  {hasRomanceIo && (
                    <span className="text-[11px] font-mono text-stone-400">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex min-h-11 items-center rounded px-1 -my-3 hover:text-fire transition-colors"
                      >
                        romance.io {"\u2197"}
                      </a>
                    </span>
