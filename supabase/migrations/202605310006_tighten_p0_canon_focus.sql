-- Tighten paid enrichment targets to romantasy and adjacent high-intent lanes.
-- The first P0 selector ranked demand correctly, but still admitted broad
-- romance/general-fiction canon books with high Goodreads counts.
